...
if (!isset($_SESSION['user_id']) || !($_SESSION['is_admin'] ?? false)) {
    error_log("Admin access denied - User ID: " . ($_SESSION['user_id'] ?? 'not set') . ", Is Admin: " . ($_SESSION['is_admin'] ?? 'not set'));
    header('Location: public/login.php');
    exit;
}

error_log("Admin access granted - User ID: {$_SESSION['user_id']}, Name: {$_SESSION['full_name']}");
